...
var Alert = function Alert(_ref) {
  var message = _ref.message,
    type = _ref.type;
  var bgColor = type === 'error' ? 'bg-red-100' : type === 'success' ? 'bg-green-100' : 'bg-yellow-100';
  var textColor = type === 'error' ? 'text-red-700' : type === 'success' ? 'text-green-700' : 'text-yellow-700';
  var borderColor = type === 'error' ? 'border-red-400' : type === 'success' ? 'border-green-400' : 'border-yellow-400';
  return /*#__PURE__*/React.createElement("div", {
    className: "p-4 mb-4 ".concat(bgColor, " ").concat(textColor, " ").concat(borderColor, " border-l-4 rounded-r-xl"),
    role: "alert"
  }, /*#__PURE__*/React.createElement("p", {
    className: "font-bold"
  }, type === 'error' ? 'Error' : type === 'success' ? 'Success' : 'Info'), /*#__PURE__*/React.createElement("p", null, message));
};
var Button = function Button(_ref2) {
  var onClick = _ref2.onClick,
    children = _ref2.children,
    _ref2$color = _ref2.color,
    color = _ref2$color === void 0 ? 'indigo' : _ref2$color;
  ...
  return /*#__PURE__*/React.createElement("button", {
    onClick: onClick,
    className: "".concat(baseClasses, " ").concat(colorClasses[color])
  }, children);
};
var CTFChallenge = function CTFChallenge() {
  ...
  var _React$useState5 = React.useState(''),
    ...
    newUsername = _React$useState6[0],
    setNewUsername = _React$useState6[1];
  ...
  var _React$useState11 = React.useState(''),
    ...
    alertMessage = _React$useState12[0],
    setAlertMessage = _React$useState12[1];
  var _React$useState13 = React.useState(''),
    _React$useState14 = _slicedToArray(_React$useState13, 2),
    alertType = _React$useState14[0],
    setAlertType = _React$useState14[1];
  var alertTimerRef = React.useRef(null);
  var showAlert = function showAlert(message, type) {
    ...
    setAlertType(type);
    alertTimerRef.current = setTimeout(function () {
      setAlertMessage('');
      setAlertType('');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            showAlert(_context.t0.message, 'error');
          case 20:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return fetch("".concat(API_BASE_URL, "/update_user"), {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
          ...
          case 16:
            ...
            showAlert(_context2.t0.message, 'error');
          case 19:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return fetch("".concat(API_BASE_URL, "/get_flag"), {
              headers: {
                'Authorization': "Bearer ".concat(token)
              }
            });
          ...
          case 6:
            ...
            showAlert("Flag: ".concat(data.flag), 'success');
            _context3.next = 12;
            break;
          case 11:
          ...
          case 14:
            ...
            showAlert(_context3.t0.message, 'error');
          case 17:
          case "end":
  ...
  }, "SVUCTF Challenge"), alertMessage && /*#__PURE__*/React.createElement(Alert, {
    message: alertMessage,
    type: alertType
  }), !token ? /*#__PURE__*/React.createElement("form", {
    onSubmit: login,
